...
# Step 4: write header module
lapack_include = os.path.join(output_dir_lapack, f"stdlib_lapack.fypp")

with open(lapack_include, 'w') as file:
    file.write("#:include \"common.fypp\" \n")
    file.write(f"module stdlib_lapack\n")
    file.write("  use stdlib_linalg_constants\n")
    ...
    for group, group_list in lapack_groups.items():
        for name in group_list:
            ...
            file.write("end interface \n")
            file.write("\n")
    file.write(f"end module stdlib_lapack\n")
...
for group, group_list in lapack_groups.items():
    ...
    with open(output_file, 'w') as file:
        # Write module header
        file.write("#:include \"common.fypp\" \n")
        file.write(f"submodule(stdlib_lapack) stdlib_lapack_{group}\n")
        file.write("  implicit none(type,external)\n")
        file.write("\n\n")
        file.write("  contains\n")
