...
module stdlib_io_mm
    ...
    interface save_mm
        ...
        module subroutine save_mm_coo_sp(filename, index, data, comment, symmetry, iostat, iomsg)
        character(len=*), intent(in) :: filename
        ...
        module subroutine save_mm_coo_dp(filename, index, data, comment, symmetry, iostat, iomsg)
        character(len=*), intent(in) :: filename
        integer, intent(in) :: index(:,:)
        ...
        module subroutine save_mm_coo_csp(filename, index, data, comment, symmetry, iostat, iomsg)
        character(len=*), intent(in) :: filename
        integer, intent(in) :: index(:,:)
        ...
        module subroutine save_mm_coo_cdp(filename, index, data, comment, symmetry, iostat, iomsg)
        character(len=*), intent(in) :: filename
        integer, intent(in) :: index(:,:)
